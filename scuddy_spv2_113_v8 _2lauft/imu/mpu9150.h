...
void icm_bank(uint8_t bank);
/*
//struct für ICM bank select
typedef struct {
	i2c_bb_state *i2cs;
	uint8_t i2c_address;
...
//#define MPU9150_INT_PIN_CFG      0x37 geändert ICM erik 22.09
#define MPU9150_INT_PIN_CFG      0x0F

#define MPU9150_INT_ENABLE       0x38
#define MPU9150_DMP_INT_STATUS   0x39
#define MPU9150_INT_STATUS       0x3A
//#define MPU9150_ACCEL_XOUT_H     0x3B geändert ICM erik 22.09
#define MPU9150_ACCEL_XOUT_H     0x2D
...
//#define MPU9150_PWR_MGMT_1       0x6B geändert für ICM BANK0 ADDR 0x06
#define MPU9150_PWR_MGMT_1       0x06
