...
MODEL           = speedgoat_IO316_CI_01476_R15b_laeuft
MODULES         = rt_matrx.c rt_printf.c rtGetInf.c rtGetNaN.c rt_nonfinite.c speedgoat_IO316_CI_01476_R15b_laeuft_capi.c speedgoat_IO316_CI_01476_R15b_laeuft_data.c xpc_datatype_ground.c rt_logging_mmi.c rtw_modelmap_utils.c rt_logging.c sg_fpga_io3xx_util.c
MAKEFILE        = speedgoat_IO316_CI_01476_R15b_laeuft.mk
...
MASTER_ANCHOR_DIR = 
START_DIR       = C:\Daten\KINGSTON\CUSTOM~1\SPEEDG~1
S_FUNCTIONS     = sg_fpga_di_sf_a2.c sg_fpga_do_sf_a2.c sg_fpga_setup_sf_3.c sg_fpga_spi_sf_1.c
S_FUNCTIONS_LIB = 
NUMST           = 2
TID01EQ         = 1
NCSTATES        = 0
...
MULTITASKING    = 0
EXT_MODE        = 0
MEX_OPT_FILE    = -f "C:\Users\MC-User\AppData\Roaming\MathWorks\MATLAB\R2017a\mex_C_win64.xml"
...
MODELLIB                  = speedgoat_IO316_CI_01476_R15b_laeuftlib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = speedgoat_IO316_CI_01476_R15b_laeuft_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\speedgoat_IO316_CI_01476_R15b_laeuft_slrt_rtw
MATLAB_INCLUDES = $(MATLAB_INCLUDES);C:\Users\MC-User\Desktop\projekt2019\Matlab\lrc-glied
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(MATLAB_ROOT)\toolbox\rtw\targets\xpc\target\build\xpcblocks\thirdpartydrivers\sg_blocks\fpga\include
...
{$(MATLAB_ROOT)\toolbox\rtw\targets\xpc\target\build\xpcblocks\thirdpartydrivers\sg_blocks\fpga\include}.c.obj :
	@cmd /C "echo ### Compiling $<"
	$(CC) $(CFLAGS) $<
{$(MATLAB_ROOT)\toolbox\rtw\targets\xpc\target\build\xpcblocks\thirdpartydrivers\sg_blocks\fpga}.c.obj :
	@cmd /C "echo ### Compiling $<"
	$(CC) $(CFLAGS) $<
{$(MATLAB_ROOT)\toolbox\rtw\targets\xpc\target\build\xpcblocks}.c.obj :
	@cmd /C "echo ### Compiling $<"
	$(CC) $(CFLAGS) $<
{$(MATLAB_ROOT)\toolbox\rtw\targets\xpc\target\build\xpcblocks\thirdpartydrivers\sg_blocks\fpga\dio}.c.obj :
	@cmd /C "echo ### Compiling $<"
	$(CC) $(CFLAGS) $<
{$(MATLAB_ROOT)\toolbox\rtw\targets\xpc\target\build\xpcblocks\thirdpartydrivers\sg_blocks\fpga\spi}.c.obj :
	@cmd /C "echo ### Compiling $<"
	$(CC) $(CFLAGS) $<
{$(MATLAB_ROOT)\rtw\c\src}.c.obj :
	@cmd /C "echo ### Compiling $<"
...
{$(MATLAB_ROOT)\toolbox\rtw\targets\xpc\target\build\xpcblocks\thirdpartydrivers\sg_blocks\fpga\include}.cpp.obj :
	@cmd /C "echo ### Compiling $<"
	$(CC) $(CPPFLAGS) $<

{$(MATLAB_ROOT)\toolbox\rtw\targets\xpc\target\build\xpcblocks\thirdpartydrivers\sg_blocks\fpga}.cpp.obj :
	@cmd /C "echo ### Compiling $<"
	$(CC) $(CPPFLAGS) $<
...
{$(MATLAB_ROOT)\toolbox\rtw\targets\xpc\target\build\xpcblocks\thirdpartydrivers\sg_blocks\fpga\dio}.cpp.obj :
	@cmd /C "echo ### Compiling $<"
	$(CC) $(CPPFLAGS) $<

{$(MATLAB_ROOT)\toolbox\rtw\targets\xpc\target\build\xpcblocks\thirdpartydrivers\sg_blocks\fpga\spi}.cpp.obj :
	@cmd /C "echo ### Compiling $<"
	$(CC) $(CPPFLAGS) $<
