/*
 * speedgoat_IO316_CI_01476_R15b_laeuft.h
 *
...
#ifndef RTW_HEADER_speedgoat_IO316_CI_01476_R15b_laeuft_h_
#define RTW_HEADER_speedgoat_IO316_CI_01476_R15b_laeuft_h_
#include <stddef.h>
#include <string.h>
#include <math.h>
#include "rtw_modelmap.h"
#ifndef speedgoat_IO316_CI_01476_R15b_laeuft_COMMON_INCLUDES_
# define speedgoat_IO316_CI_01476_R15b_laeuft_COMMON_INCLUDES_
...
#endif                                 /* speedgoat_IO316_CI_01476_R15b_laeuft_COMMON_INCLUDES_ */

#include "speedgoat_IO316_CI_01476_R15b_laeuft_types.h"
...
#define rtmGetRTWSolverInfo(rtm)       &((rtm)->solverInfo)
#define rtModel_speedgoat_IO316_CI_01476_R15b_laeuft RT_MODEL_speedgoat_IO316_CI_01476_R15b_laeuft_T

/* Definition for use in the target main file */
#define speedgoat_IO316_CI_01476_R15b_laeuft_rtModel RT_MODEL_speedgoat_IO316_CI_01476_R15b_laeuft_T
...
typedef struct {
  ...
  real_T REF;                          /* '<S5>/Gain1' */
  real_T Dio32;                        /* '<S5>/Gain2' */
  real_T Dio33;                        /* '<S5>/Gain3' */
  real_T Dio34;                        /* '<S5>/Gain4' */
  real_T Dio35;                        /* '<S5>/Gain5' */
  real_T Dio36;                        /* '<S5>/Gain6' */
  real_T U_in;                         /* '<S2>/Step' */
  real_T U_in1;                        /* '<S2>/Gain5' */
  real_T Gain;                         /* '<S2>/Gain' */
  real_T U_C;                          /* '<S2>/Discrete-Time Integrator1' */
  ...
  real_T U_L;                          /* '<S2>/Gain2' */
  real_T I_L;                          /* '<S2>/Gain1' */
  uint32_T REFM;                       /* '<S3>/Data Type Conversion1' */
  uint32_T SPIM;                       /* '<S3>/SPI Master' */
} B_speedgoat_IO316_CI_01476_R15b_laeuft_T;
...
typedef struct {
  ...
  struct {
    int_T AcquireOK;
  } SFunction_IWORK_c;                 /* '<S7>/S-Function' */

  struct {
    int_T AcquireOK;
  } SFunction_IWORK_k;                 /* '<S8>/S-Function' */

  int_T SPIMaster_IWORK;               /* '<S3>/SPI Master' */
} DW_speedgoat_IO316_CI_01476_R15b_laeuft_T;

/* Backward compatible GRT Identifiers */
#define rtB                            speedgoat_IO316_CI_01476_R15b_laeuft_B
#define BlockIO                        B_speedgoat_IO316_CI_01476_R15b_laeuft_T
#define rtP                            speedgoat_IO316_CI_01476_R15b_laeuft_P
#define Parameters                     P_speedgoat_IO316_CI_01476_R15b_laeuft_T
#define rtDWork                        speedgoat_IO316_CI_01476_R15b_laeuft_DW
#define D_Work                         DW_speedgoat_IO316_CI_01476_R15b_laeuft_T

/* Parameters (auto storage) */
struct P_speedgoat_IO316_CI_01476_R15b_laeuft_T_ {
  real_T C;                            /* Variable: C
                                        * Referenced by:
                                        *   '<S2>/Gain'
                                        *   '<S2>/Gain1'
  ...
  real_T Setup_P2_Size[2];             /* Computed Parameter: Setup_P2_Size
                                        * Referenced by: '<Root>/Setup'
                                        */
  real_T Setup_P2[1485028];            /* Expression: bitsreamBytes
                                        * Referenced by: '<Root>/Setup'
                                        */
  ...
  real_T PulseGenerator_Amp;           /* Expression: 1
                                        ...
                                        */
  real_T PulseGenerator_Period;        /* Expression: 200
                                        * Referenced by: '<S1>/Pulse Generator'
                                        */
  real_T PulseGenerator_Duty;          /* Expression: 100
                                        * Referenced by: '<S1>/Pulse Generator'
                                        */
  ...
  real_T Digitaloutput_P2_Size[2];     /* Computed Parameter: Digitaloutput_P2_Size
                                        * Referenced by: '<S1>/Digital output'
                                        */
  real_T Digitaloutput_P2[5];          /* Expression: chan
                                        * Referenced by: '<S1>/Digital output'
                                        */
  ...
  real_T Digitaloutput_P4_Size[2];     /* Computed Parameter: Digitaloutput_P4_Size
                                        * Referenced by: '<S1>/Digital output'
                                        */
  real_T Digitaloutput_P4[5];          /* Expression: reset
                                        * Referenced by: '<S1>/Digital output'
                                        */
  real_T Digitaloutput_P5_Size[2];     /* Computed Parameter: Digitaloutput_P5_Size
                                        * Referenced by: '<S1>/Digital output'
                                        */
  real_T Digitaloutput_P5[5];          /* Expression: init
                                        * Referenced by: '<S1>/Digital output'
                                        */
  ...
  real_T DiscreteTimeIntegrator1_IC;   /* Expression: 0
                                        * Referenced by: '<S2>/Discrete-Time Integrator1'
                                        */
  real_T DiscreteTimeIntegrator1_UpperSa;/* Expression: 1
                                          * Referenced by: '<S2>/Discrete-Time Integrator1'
                                          */
  real_T DiscreteTimeIntegrator1_LowerSa;/* Expression: -1
                                          * Referenced by: '<S2>/Discrete-Time Integrator1'
                                          */
...
extern P_speedgoat_IO316_CI_01476_R15b_laeuft_T
  speedgoat_IO316_CI_01476_R15b_laeuft_P;

/* Block signals (auto storage) */
extern B_speedgoat_IO316_CI_01476_R15b_laeuft_T
  speedgoat_IO316_CI_01476_R15b_laeuft_B;

/* Block states (auto storage) */
extern DW_speedgoat_IO316_CI_01476_R15b_laeuft_T
  speedgoat_IO316_CI_01476_R15b_laeuft_DW;

/*====================*
 * External functions *
 *====================*/
extern speedgoat_IO316_CI_01476_R15b_laeuft_rtModel
...
extern const rtwCAPI_ModelMappingStaticInfo*
  speedgoat_IO316_CI_01476_R15b_laeuft_GetCAPIStaticMap(void);

/* Real-time Model object */
extern RT_MODEL_speedgoat_IO316_CI_01476_R15b_laeuft_T *const
 ...
 *
 * '<Root>' : 'speedgoat_IO316_CI_01476_R15b_laeuft'
 * '<S1>'   : 'speedgoat_IO316_CI_01476_R15b_laeuft/DIO'
 * '<S2>'   : 'speedgoat_IO316_CI_01476_R15b_laeuft/LRC '
 * '<S3>'   : 'speedgoat_IO316_CI_01476_R15b_laeuft/SPI'
 * '<S4>'   : 'speedgoat_IO316_CI_01476_R15b_laeuft/DIO/DIO 1'
 * '<S5>'   : 'speedgoat_IO316_CI_01476_R15b_laeuft/DIO/Gain-O-Mat1'
 * '<S6>'   : 'speedgoat_IO316_CI_01476_R15b_laeuft/LRC /Subsystem'
 * '<S7>'   : 'speedgoat_IO316_CI_01476_R15b_laeuft/LRC /Subsystem/DIO 1'
 * '<S8>'   : 'speedgoat_IO316_CI_01476_R15b_laeuft/SPI/Scope (xPC) 1'
 */
#endif                                 /* RTW_HEADER_speedgoat_IO316_CI_01476_R15b_laeuft_h_ */
