...
## Generated on : Tue Jan 16 11:50:53 2018
...
INCLUDES_BUILDINFO = $(START_DIR);$(START_DIR)\untitled_grt_rtw;$(MATLAB_ROOT)\extern\include;$(MATLAB_ROOT)\simulink\include;$(MATLAB_ROOT)\rtw\c\src;$(MATLAB_ROOT)\rtw\c\src\ext_mode\common;$(MATLAB_ROOT)\toolbox\rtw\targets\xpc\target\build\xpcblocks\thirdpartydrivers\sg_blocks\fpga\include
...
DEFINES_STANDARD = -DMODEL=untitled -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(MATLAB_ROOT)\rtw\c\src\rt_matrx.c $(MATLAB_ROOT)\rtw\c\src\rt_printf.c $(START_DIR)\untitled_grt_rtw\rtGetInf.c $(START_DIR)\untitled_grt_rtw\rtGetNaN.c $(START_DIR)\untitled_grt_rtw\rt_nonfinite.c $(START_DIR)\untitled_grt_rtw\untitled.c $(START_DIR)\untitled_grt_rtw\untitled_data.c rt_logging.c sg_fpga_io3xx_util.c $(MATLAB_ROOT)\toolbox\rtw\targets\xpc\target\build\xpcblocks\thirdpartydrivers\sg_blocks\fpga\sg_fpga_setup_sf_3.c
...
OBJS = rt_matrx.obj rt_printf.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj untitled.obj untitled_data.obj rt_logging.obj sg_fpga_io3xx_util.obj sg_fpga_setup_sf_3.obj
