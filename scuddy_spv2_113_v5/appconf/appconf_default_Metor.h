...
//#define APPCONF_TIMEOUT_MSEC				150 // war zu kurz für den timeout vom Tool
#define APPCONF_TIMEOUT_MSEC				400
#endif
...
#define APPCONF_SEND_CAN_STATUS_RATE_HZ		30
#endif
...
#define APPCONF_ADC_CTRL_TYPE				ADC_CTRL_TYPE_CURRENT_REV_BUTTON_BRAKE_ADC
#endif
#ifndef APPCONF_ADC_HYST
#define APPCONF_ADC_HYST					0.00
#endif
#ifndef APPCONF_ADC_VOLTAGE_START
#define APPCONF_ADC_VOLTAGE_START			0.53
#endif
#ifndef APPCONF_ADC_VOLTAGE_END
#define APPCONF_ADC_VOLTAGE_END				2.65
#endif
#ifndef APPCONF_ADC_VOLTAGE_CENTER
#define APPCONF_ADC_VOLTAGE_CENTER			1.62
#endif
#ifndef APPCONF_ADC_VOLTAGE2_START
#define APPCONF_ADC_VOLTAGE2_START			0.55
#endif
#ifndef APPCONF_ADC_VOLTAGE2_END
#define APPCONF_ADC_VOLTAGE2_END			2.65
#endif
...
#define APPCONF_ADC_RAMP_TIME_POS			0.0
#endif
#ifndef APPCONF_ADC_RAMP_TIME_NEG
#define APPCONF_ADC_RAMP_TIME_NEG			0.0
#endif
...
#define APPCONF_CHUK_SMART_REV_RAMP_TIME	0.3 
#endif
...
//#define APPCONF_BALANCE_KP				0.1 //SPV2 Serie bis 05 2022
#define APPCONF_BALANCE_KP					0.15 // ab 05 2022
#endif
#ifndef APPCONF_BALANCE_KI
//#define APPCONF_BALANCE_KI				0.15 //SPV2 Serie bis 05 2022
#define APPCONF_BALANCE_KI					0.25 //ab 05 2022
#endif
#ifndef APPCONF_BALANCE_KD
#define APPCONF_BALANCE_KD				    0.07 //SPV2 Serie bis 05 2022
#endif
#ifndef APPCONF_BALANCE_HERTZ
#define APPCONF_BALANCE_HERTZ 				1000
#endif
#ifndef APPCONF_BALANCE_PITCH_FAULT
#define APPCONF_BALANCE_PITCH_FAULT 		91
//#define APPCONF_BALANCE_PITCH_FAULT 		15      // Wheely standard Winkel Wert
#endif
...
#define APPCONF_BALANCE_OVERSPEED_DUTY  	0.0 // bei 0,5 wird das automatische runterholen aktiviert
#endif
...
#define APPCONF_BALANCE_TILTBACK_SPEED 		3.0
#endif
#ifndef APPCONF_BALANCE_TILTBACK_HIGH_V
#define APPCONF_BALANCE_TILTBACK_HIGH_V 	100.0
#endif
#ifndef APPCONF_BALANCE_TILTBACK_LOW_V
//#define APPCONF_BALANCE_TILTBACK_LOW_V	 	0.03 //SPV2 Serie bis 05 2022
#define APPCONF_BALANCE_TILTBACK_LOW_V	 	0.05 // Filter für Wheely D term
#endif
...
#define APPCONF_BALANCE_STARTUP_SPEED 		6.0
#endif
#ifndef APPCONF_BALANCE_DEADZONE
#define APPCONF_BALANCE_DEADZONE 			0.3 // autoreku bei overspeed missbraucht
#endif
...
#define APPCONF_IMU_SAMPLE_RATE_HZ			500
#endif
#ifndef APPCONF_IMU_ACCEL_CONFIDENCE_DECAY
#define APPCONF_IMU_ACCEL_CONFIDENCE_DECAY	1.5
#endif
...
#define APPCONF_IMU_G_OFFSET_COMP_FACT_0	0.2
#endif
#ifndef APPCONF_IMU_G_OFFSET_COMP_FACT_1
#define APPCONF_IMU_G_OFFSET_COMP_FACT_1	0.2
#endif
#ifndef APPCONF_IMU_G_OFFSET_COMP_FACT_2
#define APPCONF_IMU_G_OFFSET_COMP_FACT_2	0.2
#endif
#ifndef APPCONF_IMU_G_OFFSET_COMP_CLAMP
#define APPCONF_IMU_G_OFFSET_COMP_CLAMP		8.0
#endif
