...
float buffer_get_float16u(const uint8_t *buffer, float scale, int32_t *index) {
    return (float)buffer_get_uint16(buffer, index) / scale;
}
float buffer_get_float16u_inv(const uint8_t *buffer, float scale, int32_t *index) {
    return (float)buffer_get_uint16_inv(buffer, index) / scale;
}
float buffer_get_float16_inv(const uint8_t *buffer, float scale, int32_t *index) {
    return (float)buffer_get_int16_inv(buffer, index) / scale;
}
