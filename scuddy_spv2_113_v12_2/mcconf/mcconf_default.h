...
#define MCCONF_L_IN_CURRENT_MAX			58.0	// Input current limit in Amperes (Upper)
#endif
#ifndef MCCONF_L_IN_CURRENT_MIN
#define MCCONF_L_IN_CURRENT_MIN			-40.0	// Input current limit in Amperes (Lower) // Sanyo:max3,35A/cell
#endif

#define SET_IN_CURRENT_MAX_BY_BATTERY    2.65    // Vielfaches der Kapazität als Strom
#define SET_IN_CURRENT_MIN_BY_BATTERY    -1.45   // Vielfaches der Kapazität als Reku Strom - ACHTUNG NEGATIVWERT!
...
#define MCCONF_L_MAX_VOLTAGE			((4.200*MCCONF_SI_BATTERY_CELLS)+1.7)	// 60.5 Maximum input voltage
#endif
...
#define MCCONF_L_BATTERY_CUT_END		(2.500*MCCONF_SI_BATTERY_CELLS)		// Limit the positive current completely at this voltage
#endif
...
//#define MCCONF_L_WATT_MAX				9000.0	// Maximum wattage output
#endif
...
#define MCCONF_FOC_CURRENT_KP			0.0343
#endif
#ifndef MCCONF_FOC_CURRENT_KI
#define MCCONF_FOC_CURRENT_KI			23.88
#endif
...
#define MCCONF_FOC_MOTOR_L				0.00001250
#endif
#ifndef MCCONF_FOC_MOTOR_R
#define MCCONF_FOC_MOTOR_R				0.0120
#endif
#ifndef MCCONF_FOC_MOTOR_FLUX_LINKAGE
#define MCCONF_FOC_MOTOR_FLUX_LINKAGE	0.006666
#endif
#ifndef MCCONF_FOC_OBSERVER_GAIN
#define MCCONF_FOC_OBSERVER_GAIN		2000e4		// Can be something like 600 / L
#endif
...
#define MCCONF_FOC_SL_D_CURRENT_FACTOR	0.4		// Maximum q-axis current factor
#endif
#ifndef MCCONF_FOC_HALL_TAB_0
#define MCCONF_FOC_HALL_TAB_0			255
#endif
#ifndef MCCONF_FOC_HALL_TAB_1
#define MCCONF_FOC_HALL_TAB_1			163
#endif
#ifndef MCCONF_FOC_HALL_TAB_2
#define MCCONF_FOC_HALL_TAB_2			29
#endif
#ifndef MCCONF_FOC_HALL_TAB_3
#define MCCONF_FOC_HALL_TAB_3			194
#endif
#ifndef MCCONF_FOC_HALL_TAB_4
#define MCCONF_FOC_HALL_TAB_4			95
#endif
#ifndef MCCONF_FOC_HALL_TAB_5
#define MCCONF_FOC_HALL_TAB_5			129
#endif
#ifndef MCCONF_FOC_HALL_TAB_6
#define MCCONF_FOC_HALL_TAB_6			63
#endif
#ifndef MCCONF_FOC_HALL_TAB_7
#define MCCONF_FOC_HALL_TAB_7			255
#endif
#ifndef MCCONF_FOC_SL_ERPM
#define MCCONF_FOC_SL_ERPM				9000.0	// ERPM above which only the observer is used
#endif
...
#define MCCONF_M_CURRENT_BACKOFF_GAIN	5.0		// Missbraucht für Strommes-korrektur FOC 30 03 2021
#endif
...
#define MCCONF_SI_MOTOR_POLES			16 // Motor pole count
#endif
#ifndef MCCONF_SI_GEAR_RATIO
#define MCCONF_SI_GEAR_RATIO			(69.0/16.0) // Gear ratio
#endif
#ifndef MCCONF_SI_WHEEL_DIAMETER
#define MCCONF_SI_WHEEL_DIAMETER		0.255 // Wheel Diameter // gemsessen 21.06.2021 3,5 bar 10 Umdrehungen = 7,47m --> 238mm real
#endif
...
#define MCCONF_SI_BATTERY_AH			20.7 // Battery amp hours
#endif

#ifndef MCCONF_L_RPM_MAX
//#define MCCONF_L_RPM_MAX				36601.40	// The motor speed limit (Upper) 48km/h steht unten nach motor poles
