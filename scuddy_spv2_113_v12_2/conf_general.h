...
#define SCUDDY_VERSION          113
//scuddy changelog
//1.05 Major release
//1.06 IMU Adresse variabel gemacht - kleine Änderungen
//1.07 Anpassungen für METOR 12S & 13S und fractional limits Longco
//1.08 Pretest Metor ist nach München gegangen
//1.09 Release METOR Juli 2023 Recu Regler massiv überarbeitet anderer Observer
//1.10 Neuer Observer nur bei METOR
//1.11 QUAD Release Ri 170mOhm
//1.12 QUAD Release Ri 145mOhm
//1.13 MC interface -->Voltage config wird anhand der BMS Informationen selbständig angepasst

// Fahrzeug
#define SCUDDY_CONF
//#define METOR // Neuer Observer
//#define SCUDDY_36V

//#define EBB_ID0
//#define LONCO_ID0_AWD
//#define LONCO_ID0_RWD
//#define LONCO_ID3_AWD
//#define LONCO_ID4_RWD
//#define LONCO_ID4_AWD
...
#define HW_SOURCE "hw_SV30.c"
#define HW_HEADER "hw_SV30.h"
...
#ifdef METOR
#include "mcconf_default_Metor.h"
#include "appconf_default_Metor.h"
#endif

#ifdef SCUDDY_36V
#include "mcconf_default_36V.h"
#include "appconf_default.h"
#endif

#ifdef EBB_ID0
#include "mcconf_default_EBB_ID0.h"
#include "appconf_default_EBB_ID0.h"
#endif

#ifdef LONCO_ID0_AWD
#include "mcconf_default_LONCO_ID0_AWD.h"
#include "appconf_default_EBB_ID0.h"
#endif

#ifdef LONCO_ID0_RWD
#include "mcconf_default_LONCO_ID0_4_RWD.h"
#include "appconf_default_EBB_ID0.h"
#endif

#ifdef LONCO_ID3_AWD
#include "mcconf_default_LONCO_ID3_4_AWD.h"
#include "appconf_default_EBB_ID3.h"
#endif

#ifdef LONCO_ID4_RWD
#include "mcconf_default_LONCO_ID0_4_RWD.h"
#include "appconf_default_EBB_ID4.h"
#endif
...
#ifdef QUAD_154_ID0
//#define FRONT
#include "mcconf_default_QUAD_154_ID0_4.h"
#ifdef BROTKASTEN
#include "appconf_default_QUAD_BROTKASTEN_ID0.h"
#elif defined(STAHLSCHWEIN)
#include "appconf_default_QUAD_STAHLSCHWEIN_ID0.h"
#endif
#endif
...
#include "mcconf_default_QUAD_154_ID0_4.h"
#include "appconf_default_QUAD_ID4.h"
#endif

#ifdef QUAD_90_ID0
#define FRONT
#include "mcconf_default_QUAD_90_ID0_4.h"
#ifdef BROTKASTEN
#include "appconf_default_QUAD_BROTKASTEN_ID0.h"
#elif defined(STAHLSCHWEIN)
#include "appconf_default_QUAD_STAHLSCHWEIN_ID0.h"
...
void conf_general_read_custom_configuration(custom_configuration *conf); // Jörn 08 2020
bool conf_general_store_eeprom_var_hw(eeprom_var *v, int address);
bool conf_general_store_custom_configuration(custom_configuration *conf); // Jörn 08 2020
void conf_general_read_app_configuration(app_configuration *conf);
bool conf_general_store_app_configuration(app_configuration *conf);
void save_odo_value(uint32_t value);
