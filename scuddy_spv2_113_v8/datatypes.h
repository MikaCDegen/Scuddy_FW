...
typedef enum {
    ...
    FAULT_CODE_DRV_CONFIG,
	FAULT_CODE_THROTTLE_OVERVOLTAGE,
	
	//ab hier nur Info Fehler

	FAULT_CODE_THROTTLE_UNDERVOLTAGE,
	FAULT_CODE_RECU_OVERVOLTAGE,
	FAULT_CODE_RECU_UNDERVOLTAGE
} mc_fault_code;
...
typedef struct {
	// Settings
	//Joern 24.8.2020 km  zähler bei undervoltage
	//uint32_t tacho_abs_save;
	uint32_t odo_save;
...
typedef enum {
	...
	CAN_PACKET_CONF_CURRENT_LIMITS,			//15
	CAN_PACKET_CONF_STORE_CURRENT_LIMITS,
	CAN_PACKET_CONF_CURRENT_LIMITS_IN,		//17
	CAN_PACKET_CONF_STORE_CURRENT_LIMITS_IN,
	CAN_PACKET_CONF_FOC_ERPMS,
	CAN_PACKET_CONF_STORE_FOC_ERPMS,
	CAN_PACKET_STATUS_5,
	CAN_PACKET_ENVIRO,		//1C
	CAN_PACKET_ADC_REKU,		//1D
	CAN_PACKET_ADC_GAS,		//1E
	CAN_PACKET_VOLTAGE_DISPLAY,	//1F
	CAN_PACKET_VOLTAGE_BMS,		//20
	CAN_PACKET_CELL_MIN_MAX,		//21
	CAN_PACKET_CONF_SPEED,		//22
	CAN_PACKET_CONF_BRK_REKU,	//23
	CAN_PACKET_CONF_POWER,		//24
	CAN_PACKET_STATUS_6,		//25
	CAN_PACKET_DETECT_SENSORS_FOC,
	CAN_PACKET_STATUS_7,
	CAN_PACKET_CONF_CURRENT_FRACTIONAL,		//28
	CAN_PACKET_CONF_FRONT_REAR		//29
} CAN_PACKET_ID;
