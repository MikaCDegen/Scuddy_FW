...
#define LD_LQ_DIFF 50e-6                	//siehe mcpwm_foc Zeile 2631
//Lq gemessen 228µH
//Ld gemessen 165µH 

#define MAX_KMH                         90 // 48, 36, 31, 26, 21, 16, 6

//#define FRONT                           
#define MIDDLE                          
//#define REAR  

//#define DIVIDE_WATTAGE_BY_NBR_OF_VESCS  

#define TIMEOUT_BEEP                    1
...
#define MCCONF_L_CURRENT_MAX			225.0	// Current limit in Amperes (Upper)
#endif
#ifndef MCCONF_L_CURRENT_MIN
#define MCCONF_L_CURRENT_MIN			-175.0	// Current limit in Amperes (Lower)
#endif
#ifndef MCCONF_L_IN_CURRENT_MAX
#define MCCONF_L_IN_CURRENT_MAX			175.0	// Input current limit in Amperes (Upper)
#endif
#ifndef MCCONF_L_IN_CURRENT_MIN
#define MCCONF_L_IN_CURRENT_MIN			-80.0	// Input current limit in Amperes (Lower) // Sanyo:max3,35A/cell
#endif

#define SET_IN_CURRENT_MAX_BY_BATTERY    5.00    // Vielfaches der Kapazität als Strom 37*6
#define SET_IN_CURRENT_MIN_BY_BATTERY    -2.5   // Vielfaches der Kapazität als Reku Strom - ACHTUNG NEGATIVWERT!

#ifndef MCCONF_L_MAX_ABS_CURRENT
#define MCCONF_L_MAX_ABS_CURRENT		330.0	// The maximum absolute current above which a fault is generated
#endif
#ifndef MCCONF_L_MIN_VOLTAGE
#define MCCONF_L_MIN_VOLTAGE			(2.000*MCCONF_SI_BATTERY_CELLS)		// Minimum input voltage
#endif
#ifndef MCCONF_L_MAX_VOLTAGE
#define MCCONF_L_MAX_VOLTAGE			((4.200*MCCONF_SI_BATTERY_CELLS)+2.7)	// 60.5 Maximum input voltage
#endif
...
#define MCCONF_L_BATTERY_CUT_START		(3.200*MCCONF_SI_BATTERY_CELLS)	// Start limiting the positive current at this voltage
#endif
#ifndef MCCONF_L_BATTERY_CUT_END
#define MCCONF_L_BATTERY_CUT_END		(2.600*MCCONF_SI_BATTERY_CELLS)		// Limit the positive current completely at this voltage
//#define MCCONF_L_BATTERY_CUT_END		(2.700*MCCONF_SI_BATTERY_CELLS)		// Limit the positive current completely at this voltage
#endif
...
#define MCCONF_L_WATT_MAX				7000.0	// Maximum wattage output
#endif
#ifndef MCCONF_L_WATT_MIN
#define MCCONF_L_WATT_MIN				-5000.0	// Minimum wattage output (braking)
#endif
...
#define MCCONF_S_PID_KP					0.005	// Proportional gain
#endif
...
#define MCCONF_P_PID_KP					0.00300	// Proportional gain
#endif
#ifndef MCCONF_P_PID_KI
#define MCCONF_P_PID_KI					0.00500		// Integral gain
#endif
#ifndef MCCONF_P_PID_KD
#define MCCONF_P_PID_KD					0.0000	// Derivative gain
#endif
#ifndef MCCONF_P_PID_KD_FILTER
#define MCCONF_P_PID_KD_FILTER			0.010		// Derivative filter
#endif
#ifndef MCCONF_P_PID_ANG_DIV
#define MCCONF_P_PID_ANG_DIV			5.0		// Divide angle by this value
#endif
...
#define MCCONF_CC_STARTUP_BOOST_DUTY	0.00	// The lowest duty cycle to use in current control mode (has to be > MCPWM_MIN_DUTY_CYCLE)
#endif
...
#define MCCONF_HALL_ERPM				300.0	//  //hall_sl_erpm wird missbraucht um die Rampe bei Bremsen bis 0 km/H einzustellen einzustellen
#endif

// FOC
#ifndef MCCONF_FOC_CURRENT_KP
//#define MCCONF_FOC_CURRENT_KP			0.1659
#define MCCONF_FOC_CURRENT_KP			0.2934
#endif
#ifndef MCCONF_FOC_CURRENT_KI
//#define MCCONF_FOC_CURRENT_KI			12.77
#define MCCONF_FOC_CURRENT_KI		    22.38
#endif
...
#define MCCONF_FOC_PLL_KP				1000.0
#endif
#ifndef MCCONF_FOC_PLL_KI
#define MCCONF_FOC_PLL_KI				20000.0
#endif
#ifndef MCCONF_FOC_MOTOR_L
//#define MCCONF_FOC_MOTOR_L				0.0000700
#define MCCONF_FOC_MOTOR_L				120e-6
#endif
#ifndef MCCONF_FOC_MOTOR_R
//#define MCCONF_FOC_MOTOR_R				0.0128
#define MCCONF_FOC_MOTOR_R				11.5e-3
#endif
#ifndef MCCONF_FOC_MOTOR_FLUX_LINKAGE
#define MCCONF_FOC_MOTOR_FLUX_LINKAGE	32e-3
#endif
#ifndef MCCONF_FOC_OBSERVER_GAIN
//#define MCCONF_FOC_OBSERVER_GAIN		0.1e6		// Can be something like 600 / L
#define MCCONF_FOC_OBSERVER_GAIN		0.15e6		// Can be something like 600 / L
#endif
#ifndef MCCONF_FOC_OBSERVER_GAIN_SLOW
//#define MCCONF_FOC_OBSERVER_GAIN_SLOW	0.03		// Observer gain scale at minimum duty cycle
#define MCCONF_FOC_OBSERVER_GAIN_SLOW	0.02		// Observer gain scale at minimum duty cycle
#endif
...
#define MCCONF_FOC_SL_D_CURRENT_DUTY	0.8		// Inject d-axis current below this duty cycle in sensorless more // missbraucht für feldschwäche
#endif
#ifndef MCCONF_FOC_SL_D_CURRENT_FACTOR
#define MCCONF_FOC_SL_D_CURRENT_FACTOR	0.4		// Maximum q-axis current factor // missbraucht für Strom
#endif
#ifndef MCCONF_FOC_HALL_TAB_0
#define MCCONF_FOC_HALL_TAB_0			255     //200=360grad --> 1,8Grad je tick --> 33,33 ticks je Hallstep
#endif
#ifndef MCCONF_FOC_HALL_TAB_1
#define MCCONF_FOC_HALL_TAB_1			100
#endif
#ifndef MCCONF_FOC_HALL_TAB_2
#define MCCONF_FOC_HALL_TAB_2			167
#endif
#ifndef MCCONF_FOC_HALL_TAB_3
#define MCCONF_FOC_HALL_TAB_3			133
#endif
#ifndef MCCONF_FOC_HALL_TAB_4
#define MCCONF_FOC_HALL_TAB_4			33
#endif
#ifndef MCCONF_FOC_HALL_TAB_5
#define MCCONF_FOC_HALL_TAB_5			67
#endif
...
//#define MCCONF_FOC_SL_ERPM				1500.0	// ERPM above which only the observer is used ~9km/h
#define MCCONF_FOC_SL_ERPM				2500.0	// ERPM above which only the observer is used ~9km/h
#endif
...
//#define MCCONF_FOC_SAT_COMP				0.15		// Stator saturation compensation
#define MCCONF_FOC_SAT_COMP				0.05		// Stator saturation compensation
#endif
...
#define MCCONF_M_CURRENT_BACKOFF_GAIN	1.8		// Missbraucht für Strommes-korrektur FOC 30 03 2021
#endif
...
#define MCCONF_M_DRV8301_OC_ADJ			15 // DRV8301 over current protection threshold
#endif
...
#define MCCONF_M_NTC_MOTOR_BETA			122 // Beta value for motor termistor // wenn 122 dann andere sensorkurve
#endif
...
#define MCCONF_SI_GEAR_RATIO			(52.0/15.0) // Gear ratio
#endif
#ifndef MCCONF_SI_WHEEL_DIAMETER
#define MCCONF_SI_WHEEL_DIAMETER		0.575 // Wheel Diameter 
#endif
...
#define MCCONF_SI_BATTERY_AH			37 // Battery amp hours
#endif

#ifndef MCCONF_L_RPM_MAX
#define MCCONF_L_RPM_MAX				(MAX_KMH*((MCCONF_SI_MOTOR_POLES / 2.0) * 1000.0 / 60.0 * MCCONF_SI_GEAR_RATIO) / (MCCONF_SI_WHEEL_DIAMETER * 3.14159265358979323846))	// The motor speed limit (Upper) METOR 90km/h = 14393ERM
#endif
#ifndef MCCONF_L_RPM_MIN
#define MCCONF_L_RPM_MIN				-4000.00	// The motor speed limit (Lower)
#endif
