...
//#define SET_IN_CURRENT_MAX_BY_BATTERY   4.0    // Vielfaches der Kapazität als Strom
//#define SET_IN_CURRENT_MIN_BY_BATTERY   -2.0   // Vielfaches der Kapazität als Reku Strom - ACHTUNG NEGATIVWERT!
...
#define MCCONF_L_MAX_VOLTAGE			((4.200*MCCONF_SI_BATTERY_CELLS)+2.7)	// Maximum input voltage
#endif
...
#define MCCONF_L_WATT_MAX				1700.0	// Maximum wattage output // wichtig für den Drehzahlregler
#endif
#ifndef MCCONF_L_WATT_MIN
#define MCCONF_L_WATT_MIN				-1500.0	// Minimum wattage output (braking)
#endif
...
#define MCCONF_S_PID_KI					0.02	// Integral gain
#endif
...
#define MCCONF_P_PID_ANG_DIV		    20.0		// Divide angle by this value
#endif
...
#define MCCONF_HALL_ERPM				1000.0	// //hall_sl_erpm wird missbraucht um die Rampe bei Bremsen bis 0 km/H einzustellen einzustellen
#endif

// FOC
#ifndef MCCONF_FOC_CURRENT_KP
#define MCCONF_FOC_CURRENT_KP			0.5995
#endif
#ifndef MCCONF_FOC_CURRENT_KI
#define MCCONF_FOC_CURRENT_KI			192.5
#endif
...
#define MCCONF_FOC_MOTOR_L				400e-6
#endif
#ifndef MCCONF_FOC_MOTOR_R
//#define MCCONF_FOC_MOTOR_R				192.5e-3 //Vorserie
#define MCCONF_FOC_MOTOR_R				145.0e-3 //Charge 1
#endif
#ifndef MCCONF_FOC_MOTOR_FLUX_LINKAGE
//#define MCCONF_FOC_MOTOR_FLUX_LINKAGE	32.627e-3 //Vorserie
#define MCCONF_FOC_MOTOR_FLUX_LINKAGE	29.000e-3 //Charge 1
#endif
#ifndef MCCONF_FOC_OBSERVER_GAIN
#define MCCONF_FOC_OBSERVER_GAIN		0.05e6		// Can be something like 600 / L
#endif
...
//#define MCCONF_FOC_SL_D_CURRENT_FACTOR	0.30		// Maximum q-axis current factor // Missbraucht für Feldschwäche
#define MCCONF_FOC_SL_D_CURRENT_FACTOR	0.00		// Maximum q-axis current factor // Missbraucht für Feldschwäche
#endif
#ifndef MCCONF_FOC_HALL_TAB_0
#define MCCONF_FOC_HALL_TAB_0			255
#endif
#ifndef MCCONF_FOC_HALL_TAB_1
#define MCCONF_FOC_HALL_TAB_1			67
#endif
#ifndef MCCONF_FOC_HALL_TAB_2
#define MCCONF_FOC_HALL_TAB_2			0
#endif
...
#define MCCONF_FOC_HALL_TAB_6			168
#endif
...
#define MCCONF_M_CURRENT_BACKOFF_GAIN	1.0		// Missbraucht für Strommes-korrektur FOC 30 03 2021
#endif
...
#define MCCONF_M_NTC_MOTOR_BETA			3400.0 // Beta value for motor termistor
#endif
...
#define MCCONF_SI_MOTOR_POLES			40 // Motor pole count
#endif
#ifndef MCCONF_SI_GEAR_RATIO
#define MCCONF_SI_GEAR_RATIO			1.000 // Gear ratio
#endif
#ifndef MCCONF_SI_WHEEL_DIAMETER
#define MCCONF_SI_WHEEL_DIAMETER		0.296 // Wheel Diameter 0,935m gemessen
#endif
...
#define MCCONF_SI_BATTERY_AH			30 // Battery amp hours
#endif
...
#define MCCONF_L_RPM_MIN				-800.00	// The motor speed limit (Lower)
#endif
